											...
											<div class="input-group" >
												...
												<!-- <form action="searchAddressBookName.ad" method="post"> -->
													<span class="input-group-btn">
														<input type="text" id="searchN" name="searchN" class="form-control">
											...
											$.ajax({
												...
												success:function(data){
						                            ...
						                            $.each(list, function(i){
						                            	str += '<td class="a-center" style="width:83px;" align="center"><a onclick="checkboxArr(' + list[i].empNo +');"><i class="fa fa-sign-in fa-lg"></i></a></td>'
						                            	+ '<input type="hidden" id="loginNo" name="loginNo" value="'+ ${ loginUser.empNo } +'">'
														+ '<input type="hidden" id="empNo" name="empNo" value="' + list[i].empNo + '">'
						                            	+ '<td width="252">' + list[i].depName + '</td><td width="180">' + list[i].empName + '</td><td width="190">'
					                            	    + list[i].jobName + '</td><td width="200">' + list[i].positionName + '</td><td width="320">'
