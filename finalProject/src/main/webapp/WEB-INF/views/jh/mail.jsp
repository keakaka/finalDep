										...
										<form action="recieveedMail.ma" method="post">
											<div>
												<input type="button" name="delete" value="삭제"> <input
													type="button" name="resend" value="답장"> <input
													type="text" placeholder="메일검색하기"> <input
													type="button" name="go" value="검색">
											</div>
											<table
												...
												<thead>
													<tr class="headings">
														...
														<th class="bulk-actions" colspan="7"><a class="antoo" style="color: #fff; font-weight: 500;">선택 개수 (
