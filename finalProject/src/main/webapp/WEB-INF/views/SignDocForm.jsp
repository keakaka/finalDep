...
<head>
    ...
    <link href="${contextPath }/resources/fonts/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	<link href="${contextPath }/resources/js/dynatree/ui.dynatree.css" rel="stylesheet"/> 
    <link href="${contextPath }/resources/css/sign.css" rel="stylesheet" type="text/css">
    ...
    <script src="${contextPath }/resources/js/signDoc/metisMenu.min.js"></script>
    <script src="${contextPath }/resources/js/signDoc/sb-admin-2.js"></script>
