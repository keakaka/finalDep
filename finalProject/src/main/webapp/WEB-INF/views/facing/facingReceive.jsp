                ...
                <div class="x_content">
                  ...
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab1" class="nav nav-tabs bar_tabs right" role="tablist">
                      <li role="presentation" class="active"><a href="${contextPath }/facingReceiveList.ms?loginUser=${sessionScope.loginUser.empNo}" id="home-tabb" role="tab"  aria-controls="home" aria-expanded="true">받은쪽지함</a>
                      </li>
                      <li role="presentation" class=""><a href="${contextPath }/facinglist.ms?loginUser=${sessionScope.loginUser.empNo}"  role="tab" id="profile-tabb"  aria-controls="profile" aria-expanded="false">보낸쪽지함</a>
                      </li> 
